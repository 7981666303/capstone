...
const LiveStatusRibbon = () => {
    ...
    return (
        <div className="bg-[var(--bg-card)] border-b border-[var(--border-main)] px-4 py-3 flex items-center gap-6 text-[10px] font-black tracking-[0.15em] uppercase transition-colors duration-300 overflow-x-auto scrollbar-hide whitespace-nowrap">
